        ...
        <svg className={styles.curtainClipDefs} aria-hidden="true" width="0" height="0" focusable="false">
          <defs>
            <clipPath id="curtain-body-handoff" clipPathUnits="objectBoundingBox">
              <path d="M 0 0.136 C 0.045 0.174, 0.105 0.208, 0.188 0.2 C 0.252 0.191, 0.314 0.139, 0.348 0.092 C 0.398 0.149, 0.45 0.219, 0.5 0.226 C 0.55 0.219, 0.602 0.149, 0.652 0.092 C 0.686 0.139, 0.748 0.191, 0.812 0.2 C 0.895 0.208, 0.955 0.174, 1 0.136 L 1 1 L 0 1 Z" />
            </clipPath>
            <clipPath id="curtain-swells-cap" clipPathUnits="objectBoundingBox">
              <path d="M 0 0 L 1 0 L 1 0.136 C 0.955 0.174, 0.895 0.208, 0.812 0.2 C 0.748 0.191, 0.686 0.139, 0.652 0.092 C 0.602 0.149, 0.55 0.219, 0.5 0.226 C 0.45 0.219, 0.398 0.149, 0.348 0.092 C 0.314 0.139, 0.252 0.191, 0.188 0.2 C 0.105 0.208, 0.045 0.174, 0 0.136 Z" />
            </clipPath>
