        ...
        <svg className={styles.curtainClipDefs} aria-hidden="true" width="0" height="0" focusable="false">
          <defs>
            ...
            <clipPath id="curtain-body-handoff-mobile" clipPathUnits="objectBoundingBox">
              <path d="M 0 0.134 C 0.028 0.145, 0.06 0.152, 0.102 0.151 C 0.154 0.148, 0.205 0.12, 0.248 0.094 Q 0.5 0.286, 0.752 0.094 C 0.795 0.12, 0.846 0.148, 0.898 0.151 C 0.94 0.152, 0.972 0.145, 1 0.134 L 1 1 L 0 1 Z" />
            </clipPath>
            <clipPath id="curtain-swells-cap-mobile" clipPathUnits="objectBoundingBox">
              <path d="M 0 0 L 1 0 L 1 0.134 C 0.972 0.145, 0.94 0.152, 0.898 0.151 C 0.846 0.148, 0.795 0.12, 0.752 0.094 Q 0.5 0.286, 0.248 0.094 C 0.205 0.12, 0.154 0.148, 0.102 0.151 C 0.06 0.152, 0.028 0.145, 0 0.134 Z" />
            </clipPath>
